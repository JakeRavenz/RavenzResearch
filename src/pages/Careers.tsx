...
export default function Careers() {
  return (
    <div className="container px-4 py-8 mx-auto bg-slate-100 dark:bg-gray-900">
      <h1 className="mb-6 text-3xl font-bold text-gray-900 dark:text-white">Careers</h1>
      <div className="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        ...
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          ...
          their work and committed to our mission. We foster a collaborative and
          inclusive environment where everyone's ideas are valued.
        </p>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          We offer competitive pay rates, career growth opportunities, and a
          supportive work environment. We believe in investing in our employees
        ...
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          ...
          positions on the jobs page. We're excited to learn more about you and
          how you can contribute to Ravenz Research.
        </p>
