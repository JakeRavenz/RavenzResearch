...
export default function PrivacyPolicy() {
  return (
    <div className="container px-4 py-8 mx-auto bg-slate-100 dark:bg-gray-900">
      ...
      <h2 className="mb-4 text-2xl font-semibold text-gray-800 dark:text-gray-100">Your Rights</h2>
      <p className="mb-4 text-gray-700 dark:text-gray-300">You reserve the rights to: </p>
      <ul className="mb-4 text-gray-700 dark:text-gray-300 list-disc list-inside">
