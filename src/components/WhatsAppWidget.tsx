...
const WhatsAppWidget = () => {
  ...
  return (
    <>
      {isVisible && (
        <div
          className="fixed px-4 py-2 text-sm font-semibold text-gray-900 transition-all duration-300 border shadow-xl bottom-24 right-6 bg-white/60 dark:bg-slate-800/60 border-white/40 dark:border-slate-700 rounded-2xl backdrop-blur-md"
      ...
      <a
        ...
        className={`fixed bottom-4 right-6 p-4 text-white bg-gradient-to-br from-green-400 via-green-500 to-green-600 shadow-2xl rounded-full border-2 border-white/40 dark:border-slate-700 backdrop-blur-md hover:scale-105 hover:shadow-green-300/40 transition-all duration-300 ${
