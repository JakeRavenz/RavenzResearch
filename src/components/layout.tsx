...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-indigo-100 via-blue-50 to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900">
      {!hideLayout && <Navigation />}

      <main
        className={`flex-grow ${
          useFullWidth ? "" : "max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8"
        }`}
      >
